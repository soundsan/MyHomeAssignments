...
public class WebTable {
	...
	public static void main(String[] args) {
				...
				//To retrieve 1 entire column data
				List<WebElement> entireColumn1Data = driver.findElements(By.xpath("//span[text()='Customer Analytics Table']/following::table[2]/tbody/tr/td[3]"));
				
				for (int i = 0; i < entireColumn1Data.size(); i++) {
					String text = entireColumn1Data.get(i).getText();
				...
				//To retrieve 1 entire row or 1 entire column data
